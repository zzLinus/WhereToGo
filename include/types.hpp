...
struct RenderObject
{
  ...
  RenderObject(const char* str, int posX, int posY, int fontThick, Color c, renderType t)  // NOTE :DrawText()
      : RenderObject()
  {
    strcpy(text, str);
  ...
  RenderObject(Rectangle rect, Color c, renderType t) : RenderObject()  // NOTE :DrawRectangleRec()
  {
    m_source = rect;
    color = c;
    rdt = t;
  ...
  RenderObject(Rectangle rect, Color c, float lt, renderType t) : RenderObject()  // NOTE : DrawRectangleLinesEx()
  {
    m_source = rect;
    lineThick = lt;
    color = c;
